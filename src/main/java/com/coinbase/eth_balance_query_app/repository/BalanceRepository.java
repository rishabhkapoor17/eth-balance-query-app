...
/*
for complex queries I can define myself like
@Query("SELECT b FROM BalanceRecord b WHERE b.address = :address AND b.timestamp > :start")
List<BalanceRecord> findRecentBalances(@Param("address") String address, @Param("start") LocalDateTime start);
 */